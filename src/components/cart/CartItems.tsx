        ...
        <TableBody>
            ...
            >
                <TableCell component="th" scope="row">
                    <img src={sofa_img} alt="" className='h-[90px] w-[111px] bg-light-brown rounded-lg'/>
                </TableCell>
                <TableCell component="th" scope="row">
                <p className='poppins-regular '>{row.name}</p>
                </TableCell>
                <TableCell align="center">
                <p className='poppins-regular text-center'>{row.price}</p>
                </TableCell>
                <TableCell align="center">
                    <input type="text" className='text-center border w-[32px] h-[32px] text-center rounded-lg border-light-gray poppins-regular' value={row.quantity}/>
                </TableCell>
                <TableCell align="center">{row.subtotal}</TableCell>
                <TableCell align="right" className='cursor-pointer'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 text-dark-gold hover:text-red-500">
